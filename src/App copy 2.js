...
import Pagina7_MessaggiFamiglia from './pages/Pagina7_MessaggiFamiglia';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/pagina7-messaggi-famiglia" element={session ? <Pagina7_MessaggiFamiglia /> : <Navigate to="/" />} />

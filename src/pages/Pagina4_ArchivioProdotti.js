    ...
    return (
        <div className="container">
            <header className="header">
                <button className="btn-analisi" onClick={() => navigate('/main-menu')}>RitornoMenuPrincipale</button>
            ...
            <div className="tabs">
                ...
                <button className="btn-analisi" onClick={() => setShowAnalisiModal(true)}>📈 Analisi EconomicaAcquisti</button>
            </div>
                    ...
                    <ul className="list">
                        {prodottiFiltrati.map((prod) => (
                            <li key={prod.id} className="list-item">
                                ...
                                **<small className="item-category">Categoria: {prod.categorie ? prod.categorie.name : 'Nessuna'}</small>**

                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', color: 'white' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '5px' }}>
                        {familyMembers.map((member) => {
                            ...
                            // Nuova logica per i colori
                            let memberColor = '#6c757d'; // Default: Grigio (ora azzurro)
                            if (member.id === user?.id) {
                                memberColor = '#25D366'; // Verde per l'utente loggato
                            } else if (isOnline) {
                                memberColor = '#FFC107'; // Giallo per altri utenti online
                            } else {
                                memberColor = '#007bff'; // Azzurro per utenti offline
                            }
                            ...
                            return (
                                <div key={member.id} style={{
                                    ...
                                    <span style={{
                                        ...
                                        opacity: 1 // L'opacità del punto è sempre 1 per tutti i colori.
                                    }}></span>
                                </div>
                            );
                        })}
